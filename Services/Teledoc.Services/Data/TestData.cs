...
namespace Teledoc.Services.Data
{
    public static class TestData
    {
        ...
        {
            new Client{Organization="ОАО",Name="Рога и Копыта",ClientsINN=430144940226},
            new Client{Organization="ООО",Name="Ананас",ClientsINN=301282992942},
            new Client{Organization="ЗАО",Name="Измаил",ClientsINN=263480325470},
            new Client{Organization="ПАО",Name="Кокоро",ClientsINN=397364261307},
            new Client{Organization="ОАО",Name="Цепеш и Ко",ClientsINN=773158126820},
            new Client{Organization="ООО",Name="Рога и Копыта",ClientsINN=441275906211},
            new Client{Organization="ООО",Name="Рога и Копыта",ClientsINN=978830626815},
            new Client{Organization="ИП",Name="Артас Пендрагон",ClientsINN=516962457342},
            new Client{Organization="ИП",Name="Влад Цепеш",ClientsINN=459517949750},
            new Client{Organization="ИП",Name="Айзек Азимов",ClientsINN=871494862478},
        };
